...
public class itemphongvip extends JPanel {
	...
	public itemphongvip(ImageIcon url,Phong phong,JLabel ip_getmaphong, JLabel ip_gettenphong,JComboBox cb_getloaiphong, String name, Color bgtrangthai,int elapsedTime,int hour,int minute,int second,boolean trangthai) {
		super();
		...
		lblNewLabel_1.setIcon(new ImageIcon(getClass().getClassLoader().getResource("image/vip.png")));
		lblNewLabel_1.setBounds(191, 96, 55, 26);
		add(lblNewLabel_1);
